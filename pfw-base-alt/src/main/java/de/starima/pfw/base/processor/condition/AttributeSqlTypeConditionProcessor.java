...
@Setter
@Processor
public class AttributeSqlTypeConditionProcessor extends AbstractProcessor implements IConditionProcessor<IAttribute> {
    @ProcessorParameter
    private String description;
    @ProcessorParameter(value = "12")
    ...
    public IAttribute process(IAttribute attribute) throws Exception {
        ...
        return type.equals(attribute.getSqlType()) ? attribute : null;
    }
}