...
@Setter
@Processor
public class AttributeIsNumericConditionProcessor extends AbstractProcessor implements IConditionProcessor<IAttribute> {
    @ProcessorParameter
    ...
    public IAttribute process(IAttribute attribute) throws Exception {
        ...
        return attribute.isNumeric() ? attribute : null;
    }
}