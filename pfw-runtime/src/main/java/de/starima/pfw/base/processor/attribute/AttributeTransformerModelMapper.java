...
import de.starima.pfw.base.processor.transformator.api.IItemTransformerProcessor;
...
public class AttributeTransformerModelMapper extends AbstractProcessor implements IAttributeModelMapperProcessor {
    @ProcessorParameter()
    private Map<String , IItemTransformerProcessor<Object,Object>> attributeTransformerMap;
    ...
    public Object transformValue(IAttribute attribute, Object model) {
        ...
        IItemTransformerProcessor<Object,Object> transformer = attributeTransformerMap.get(attribute.getName());
        if (transformer == null) {
